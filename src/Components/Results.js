...
function Results(props) {
  ...
  return (
    <div>
      ...
      <p style={{"fontSize": "50px", "color": "white", "font-family":"Poppins"}}><b>Never Drink {material}!!</b></p>
      <p style={{"fontSize": "25px", "color":"white", "font-family":"Poppins"}}><i>...You should know better.</i></p>
    </div>
  )
}
